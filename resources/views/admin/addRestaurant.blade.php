        ...
        <div class="max-w-xl mx-auto sm:px-3 lg:px-4">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="overflow-x-auto relative my-4">
                    ...
                    @endif
                    <form method="POST" enctype="multipart/form-data" class='flex flex-col justify-center items-start p-8' action="{{ route('createRestaurant') }}">
                        @csrf
                        ...
                        <div class="flex justify-center items-center my-3">
                            ...
                            <input type="text" name="address" id="address" class="rounded-md shadow-sm border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50" required value="{{ old('address') }}">
                        </div>
                        <div class="flex justify-center items-center my-3">
                        ...
                        <div class="flex justify-center items-center my-3">
                            ...
                            <input type="text" name="latitude" id="latitude" class="rounded-md shadow-sm border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50" required value="{{ old('latitude') }}">
                        </div>
                        <div class="flex justify-center items-center my-3">
                            <label for="longitude" class="mr-6 w-28">Longitude</label>
                            <input type="text" name="longitude" id="longitude" class="rounded-md shadow-sm border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50" required value="{{ old('longitude') }}">
                        </div>
                        <div class="flex justify-center items-center my-3">
                        ...
                        <div class="flex justify-center items-center my-3">
                            ...
                            <select type="text" name="category" id="category" class="w-48 rounded-md shadow-sm border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50" required value="{{ old('category') }}">
